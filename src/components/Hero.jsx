...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-12">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center pt-6 md:pt-12">
        {/* Main Content */}
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-2 bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full text-blue-700 dark:text-blue-300 text-sm font-medium mt-2"
          >
          ...
          <motion.div
            ...
            className="text-2xl md:text-3xl text-gray-600 dark:text-gray-300 font-medium min-h-[2rem] flex items-center justify-center"
          >
            <RotatingHeadline
              as="h2"
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed mt-2"
          >
            {aboutLoading ? (
          ...
          >
            ...
            <motion.a
              href={siteSettings?.cv_url || '/cv-placeholder.txt'}
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="group border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 py-3 rounded-xl font-semibold hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 flex items-center space-x-2 cursor-pointer"
            >
